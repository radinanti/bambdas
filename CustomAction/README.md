...
```
## [CSPBypass.bambda](https://github.com/PortSwigger/bambdas/blob/main/CustomAction/CSPBypass.bambda)
### Reads the CSP of a response and detects if there is a CSP bypass. Big thanks https://bsky.app/profile/renniepak.nl for CSPBypass.com Note: Makes a HTTP request to https://raw.githubusercontent.com/renniepak/CSPBypass/refs/heads/main/data.tsv
#### Author: Gareth Heyes
```java
